...
RepliesRouter.post('/', UserAuthorizedSlim, PostCommentRepliesService.create_reply);

// PUT Routes

RepliesRouter.put('/:reply_id', UserAuthorizedSlim, PostCommentReplyExists, IsReplyOwner, PostCommentRepliesService.update_reply);
RepliesRouter.put('/:reply_id/user-reaction', UserAuthorizedSlim, PostCommentReplyExists, PostCommentRepliesService.toggle_user_reaction);

// DELETE Routes

RepliesRouter.delete('/:reply_id', UserAuthorizedSlim, PostCommentReplyExists, IsReplyOwner, PostCommentRepliesService.delete_reply);