...
export const create_delivery_required_props: IModelValidator[] = [
  ...
  { field: 'from_zipcode', name: 'From Zipcode', validator: (arg) => !!arg && zipcodes_map.has(arg.toString()) },
  ...
  { field: 'to_zipcode', name: 'To Zipcode', validator: (arg) => !!arg && zipcodes_map.has(arg.toString()) },
