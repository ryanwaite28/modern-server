...
export const Photos = <MyModelStaticGeneric<IPhotoModel>> sequelize.define('common_photos', {
  ...
  photo_link:          { type: Sequelize.STRING(500), allowNull: false, defaultValue: '' },
  photo_id:            { type: Sequelize.STRING(500), allowNull: false, defaultValue: '' },
