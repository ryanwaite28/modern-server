...
export const Videos = <MyModelStaticGeneric<IVideoModel>> sequelize.define('common_videos', {
  ...
  video_link:          { type: Sequelize.STRING(500), allowNull: false, defaultValue: '' },
  video_id:            { type: Sequelize.STRING(500), allowNull: false, defaultValue: '' },
