...
export const MyfavorsUserProfileSettings = <MyModelStatic> sequelize.define('myfavors_user_profile_settings', {
...
export const MyfavorsUserRatings = <MyModelStatic> sequelize.define('myfavors_user_ratings', {
  id:                  { type: Sequelize.INTEGER, primaryKey: true, autoIncrement: true },
  user_id:             { type: Sequelize.INTEGER, allowNull: false, references: { model: Users, key: 'id' } },
